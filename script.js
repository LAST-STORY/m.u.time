...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const appData = {
        courses: [
            { id: 'sec', title: 'Ethical Hacking & Cyber Security', desc: 'একদম জিরো থেকে প্রো হ্যাকার হয়ে উঠুন! এই কোর্সে পাচ্ছেন $500 মূল্যের Premium RAT, Malware, এবং Keyloggers একদম ফ্রি। রিয়েল-লাইফ প্র্যাকটিক্যাল অ্যাটাক শিখে নিজের হ্যাকিং ক্যারিয়ার গড়ুন।', price: '২৫০০', meta: ['Premium RAT Free', 'Tools Included', 'Private Community'] },
